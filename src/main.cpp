...
void updateDisplay() {
  ...
  lcd.setCursor(5, 0);
  lcd.print(T1, 1); lcd.print((char) 223); lcd.print("C ");
  //lcd.setCursor(11, 0);
  ...
  lcd.setCursor(5, 1);
  lcd.print(T2, 1); lcd.print((char) 223); lcd.print("C ");
  //lcd.setCursor(11, 1);
...
void set_mode() {
  ...
  if (currentOption == 0) {
    lcd.clear();
    lcd.setCursor(0, 0); lcd.print("Set T1:");
    lcd.setCursor(5, 1); lcd.print(set_T1);
  } 
  // Set T2
  else if (currentOption == 1) {
    lcd.clear();
    lcd.setCursor(0, 0); lcd.print("Set T2:");
    lcd.setCursor(5, 1); lcd.print(set_T2);
  }
  // updateDisplay();
}